...
riderRouter.get('/search/?', (req,res) => {
  ...
  const postal = Number(req.query.postal)
  ...
  .findAll({
    where: {
      ...
      rider_postal_code : postal || {[Op.lt]: 99999}, // Si le CP est précisé on en tient compte, sinon on prends tous les CP + les CP non renseignés
      ...
      rider_competition : competition || {[Op.or] : [0,1]}, // soit non, soit obligatoire, soit possible
